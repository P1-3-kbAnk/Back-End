package com.kbank.backend.util;
...
public class JwtUtil implements InitializingBean {
    ...
    public JwtTokenDto generateTokens(Long id, Role role) {
        return new JwtTokenDto(generateAccessToken(id, role, ACCESS_EXPIRED_MS),
    ...
    public String generateAccessToken(final Long id, final Role role, final Integer expirationPeriod) {
