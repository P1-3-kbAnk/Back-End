...
import com.kbank.backend.security.JwtAuthenticationToken;
import com.kbank.backend.security.info.JwtUserInfo;
import com.kbank.backend.enumerate.Role;
import com.kbank.backend.util.HeaderUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        JwtUserInfo userInfo = new JwtUserInfo(
                ...
                Role.valueOf(claims.get(Constant.USER_ROLE_CLAIM_NAME, String.class))
        );
